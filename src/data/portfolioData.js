/* ==========================================================================
   CONTRACTOR.HUB - Portfolio & Template Specs Data
   ========================================================================== */

export const templateSpecsData = {
  karyabuild: {
    id: 'karyabuild',
    cat: 'ecom',
  ...
  nkontruksi: {
    ...
    img: 'https://images.unsplash.com/photo-1541888946425-d0fbb186c5f7?auto=format&fit=crop&w=800&q=80',
...
export const portfolioTemplates = Object.values(templateSpecsData);
